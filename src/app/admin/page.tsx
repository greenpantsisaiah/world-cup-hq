...
export default function AdminPage() {
  const { user, profile, loading, signInWithMagicLink, signInWithPassword, signOut } = useAuth();
            ...
            <>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[var(--gold)] text-[var(--background)] font-bold rounded-lg hover:bg-[var(--gold-dim)] transition-colors disabled:opacity-50"
                >
                  Send Link
                </button>
              </div>
