                ...
                <>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <button
                      onClick={async () => {
                        ...
                        if (error) setAuthError("Unable to sign in with Microsoft.");
                      }}
                      className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-[#2f2f2f] text-white font-semibold rounded-xl hover:bg-[#404040] transition-colors"
                    >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className={`px-5 py-3 font-semibold rounded-xl transition-colors text-sm ${
                        email.includes("@")
                          ? "bg-[var(--gold)] text-[var(--background)] hover:bg-[var(--gold-dim)]"
                          : "bg-[var(--surface-light)] text-[var(--muted)] border border-[var(--surface-border)] opacity-40"
                      }`}
                    >
                      Send Link
                    </button>
